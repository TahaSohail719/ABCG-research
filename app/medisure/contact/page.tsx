...
export default function MedisureContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await submitForm('Medisure Contact Us', formDataToSend);
        ...
        <div className="flex flex-col min-h-screen bg-background pb-20">
            ...
            <section className="relative py-24 md:py-32 flex flex-col items-center justify-center text-center overflow-hidden min-h-[40vh]">
                <div className="absolute inset-0 z-0">
                    ...
                    {/* Abstract Shapes */}
                    <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-blue-500/20 rounded-full blur-[80px] animate-pulse" />
            ...
            <section className="container px-4 md:px-6 mt-8 relative z-40">
                <div className="grid gap-6 md:grid-cols-3 mb-12">
                    <Card className="text-center group hover:border-primary/50 transition-colors bg-background/50 backdrop-blur-sm">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">info@medisure.com</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="text-center group hover:border-primary/50 transition-colors bg-background/50 backdrop-blur-sm">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">+1 (000) 000-0000</p>
                        </CardContent>
                    </Card>
            ...
            <section className="container px-4 md:px-6 py-12">
                <div className="grid gap-12 lg:grid-cols-2">
                        ...
                        <form onSubmit={handleSubmit} className="flex-grow flex flex-col justify-between space-y-6 bg-white/5 p-8 rounded-3xl border border-white/10 shadow-xl backdrop-blur-sm">
                            ...
                            <div className="pt-6">
                                ...
                                <Button
                                    type="submit"
                                    size="lg"
                                    className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98]"
                    ...
                    <div className="flex flex-col h-full space-y-8">
                        <div>
                            <h2 className="text-3xl font-bold font-serif mb-2">Our Office</h2>
                            <p className="text-muted-foreground">Strategic location to serve our clients.</p>
                        </div>
                        <div className="space-y-6 flex-grow flex flex-col justify-start">
                            <Card className="border-white/10 bg-white/5 hover:border-primary/30 transition-all group overflow-hidden">
                                <CardHeader className="p-6 h-full flex flex-col justify-center">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <CardTitle className="font-serif">Sacramento, USA</CardTitle>
